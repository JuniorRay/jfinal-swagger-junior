...
(function ($) {
    ...
    var SwaggerBootstrapUi = function (options) {
        ...
        this.titleOfUrl = "http://www.softsz.com";
        this.load = 1;
        //tabid
        this.tabId = "tabUl";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(groupData, function (i, group){
                    console.log(group);
                    group.name = group.groupName;//by JuniorRay
                    group.location = group.scanPackageDir;//by JuniorRay
    ...
    SwaggerBootstrapUi.prototype.setInstanceBasicPorperties = function (menu) {
        ...
        if (menu.hasOwnProperty("info")) {
            var info = menu.info;
            title = $.getValue(info, "title", "安软科技-API接口文档", true);
            description = $.getValue(info, "description", "最终解释权归安软科技公司所有", true);
            if (info.hasOwnProperty("contact")) {
                // var contact = info["contact"];
                // name = $.getValue(contact, "name", "Junior Ray", true);
                name = $.getValue(info, "contact", "Junior Ray", true);

            }
            version = $.getValue(info, "swaggerVersion", "1.0", true);
        ...
        if (title != null && title != undefined && title != "") {
            ...
            if (that.load == 1) {
                ...
                that.load = 2;
                $("#swaggerBootstrapHrefTitle").attr("href", "http://www.softsz.com")
            }
        } else {
